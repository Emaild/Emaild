...
<h3>Emaild</h3>
  <ul class="nav nav-pills">
    ...
    <li class="nav-item">
      <a class="nav-link" href="forms/signin.php">LOGIN</a>
    </li>
  </ul>
</nav>
<div>
  ...
  <div>
      <center><img src="images/back4.jpg" style="height: 633px;"></center>
  </div>
    <div class="hero_home__copy" style="width:700px;">
      <h1 style="color:black; z-index:10; padding-top:15%;">The ease &amp; simplicity of Emaild</h1>
